 ...
 * smartLink
 */
public class SmartLinkActivity extends StatusActivity {
    ...
    private void init() {
        ...
        btnBack = (Button)findViewById(R.id.SmartLinkBtnBack);
        clicks();
    }
...
//    ffaa1112131415161718ff1801000101ff55
    ...
    private class MyHandler extends Handler {
        ...
        public void handleMessage(Message msg) {
            ...
            if (msg.what == 2) {
                showDialog("连接失败", "请检查时候有别的设备开启过SmartLink功能，请复位系统尝试重新连接到该网络");
                progressBar.setProgress(0);
                removeRobotAP(robotAPSSID);
                btnStartClick = false;
