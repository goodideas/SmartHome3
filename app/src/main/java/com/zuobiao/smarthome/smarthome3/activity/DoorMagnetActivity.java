...
public class DoorMagnetActivity extends StatusActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        udpHelper.setDoorMagnetUI(tvDoorMagnet);
...
//            etEquipmentName.setText(new String(util.HexString2Bytes(dBcurd.getNickNameByMac(equipmentBean.getMac_ADDR()).substring(4))));
