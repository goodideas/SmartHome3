...
//        udpHelper.setCurtainsUI(tbWindow, tbCurtains);
...
//        tbWindow.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
//            @Override
//            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
//                if(isChecked){
//                    statusWindow = (byte)0x01;
//                    udpHelper.send(getCurtainsSendData(statusCurtains,statusWindow));
//                }else{
//                    statusWindow = (byte)0x00;
//                    udpHelper.send(getCurtainsSendData(statusCurtains,statusWindow));
//                }
//            }
//        });
