...
//	private int CHECKED_COLOR = Color.rgb(255, 255, 255);
	...
	public void setChecked(int itemID){
		...
		switch (itemID){
		case Constant.BTN_FLAG_EQUIPMENT:
			checkDrawableId = R.drawable.equipment_press;
			break;
		case Constant.BTN_FLAG_SCENE:
			checkDrawableId = R.drawable.scene_press;
			break;
		case Constant.BTN_FLAG_SETTING:
			checkDrawableId = R.drawable.setting_press;
			break;
		default:break;
		}
		if(mImageView != null){
